...
{           
	...
	DAC1CONL = 0xE010; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Rising or falling edge detect; INSEL CMP1C; DACOEN disabled; 
